...
namespace ClinicWebApplication.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public AppointmentsController(DBClinicContext context)
        {
            _context = context;
        }
        ...
        {
            var dBClinicContext = _context.Appointments.Include(a => a.Patient).Include(a => a.Schedule);
        ...
        public async Task<IActionResult> Create([Bind("Id,PatientId,ScheduleId,Time")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PatientId,ScheduleId,Time")] Appointment appointment)
        {
