...
namespace ClinicWebApplication.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public CitiesController(DBClinicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            //return View(city);
            return RedirectToAction("Index", "Hospitals", new { id = city.Id, name = city.Name });
        }
        ...
        {
            var hospitals = _context.Hospitals.Where(h => h.CityId == id);
            _context.Hospitals.RemoveRange(hospitals);
