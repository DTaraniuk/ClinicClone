...
namespace ClinicWebApplication.Controllers
{
    public class OfficesController : Controller
    {
        ...
        public OfficesController(DBClinicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,OfficeNumber")] Office office)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OfficeNumber")] Office office)
        {
            if (id != office.Id)
            {
                return NotFound();
        ...
        {
            var doctorOffices = _context.DoctorOffices.Where(DO => DO.OfficeId == id);
